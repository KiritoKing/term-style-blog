...
Define repository-backed agent task state, handoff, and report behavior so Codex supervisor, worker, and reviewer sessions can recover and coordinate work from versioned files instead of chat context.
